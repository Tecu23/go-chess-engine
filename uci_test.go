...
func Test_Uci(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"fen",
			"position fen rnbqkb1r/ppp1pp1p/5np1/3p4/3P1B2/2N1P3/PPP2PPP/R2QKBNR b KQkq - 1 4",
			[]string{"info string position fen not implemented"},
		},
		{
			"startpos",
			"position startpos",
			[]string{"info string position startpos not implemented"},
		},
